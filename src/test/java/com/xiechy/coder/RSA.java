...
public class RSA {
    ...
    public static void main(String[] args) throws Exception{
        String password = "abcdefghijklmnopqrstuvzxcy";
        KeyPair key = getKeyPair(password);
        ...
        //私钥加密
        String encryptData = encryptByPrivateKey("我是私钥加密的数据", privateKey);
        //公钥解密
        String decryptData = decryptByPublicKey(encryptData,publicKey);

        System.out.println("私钥加密后的数据：" + encryptData);
        System.out.println("公钥解密后的数据：" + decryptData);

        //公钥加密
        String encrypt = encryptByPublicKey("我是公钥加密的数据", publicKey);
